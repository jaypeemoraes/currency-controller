defmodule ExerciseWeb.Router do
  ...
  scope "/api", ExerciseWeb do
    ...
    get "/employees/salaries/metrics/country/:code", EmployeeController, :metrics_salaries_by_country
    get "/employees/salaries/metrics/job-title/:job", EmployeeController, :metrics_salaries_by_job_title
